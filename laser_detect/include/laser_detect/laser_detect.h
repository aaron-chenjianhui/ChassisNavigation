...
void DataSelect(double min_angle, double max_angle, lidar_data_type& lidar_data_in, lidar_data_type& lidar_data_out);
void DataFilter(lidar_data_type& lidar_data_in, lidar_data_type& lidar_data_out);
void DataIgn(vec_data_type & ign_angle, lidar_data_type& lidar_data_in, lidar_data_type& lidar_data_out);


void FindUltiData(const lidar_data_type & lidar_data, const std::vector<bool>& vote_index, double                 & min_angle, double                 & min_data, double                 & max_angle, double                 & max_data);
 ...
 * @return            [description]
 */
bool WallDetect(lidar_data_type& lidar_data, vec_data_type  & l_param, vec_data_type  & r_param, vec_data_type  & f_param, vec_data_type  & enter_param);
 ...
 */
void FindOriPose(vec_data_type& l_param, vec_data_type& r_param, vec_data_type& f_param, vec_data_type& ori_pose);
void FindWallLen(const vec_data_type& ori_pose, const vec_data_type& enter_param, double             & l_len, double             & r_len);
 ...
 */
bool FindCorner(const lidar_data_type& lidar_data, double               & min_angle, double               & max_angle);
...
bool ResultCheck(vec_data_type& l_param, vec_data_type& r_param, vec_data_type& f_param);
void ResultDisp(lidar_data_type& lidar_data, vec_data_type  & ori_pose, vec_data_type  & left_line_param, vec_data_type  & right_line_param, vec_data_type  & front_line_param);
void BWFilter(lidar_filter_type& filter_data_in, lidar_filter_type& filter_data_out, vec_data_type    & Az, vec_data_type    & Bz);
void MAFilter(lidar_filter_type& filter_data_in, lidar_data_type  & filter_data_out, int ave_num);

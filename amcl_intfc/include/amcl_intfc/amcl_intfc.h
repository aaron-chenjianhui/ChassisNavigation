...
AMCLIntfc();
AMCLIntfc(double pos_cov_thre, double ori_cov_thre);
~AMCLIntfc();
...
bool statusCallback(laser_msgs::amcl_srv::Request & req, laser_msgs::amcl_srv::Response& res);

bool isCovSmall(const geometry_msgs::PoseWithCovarianceStamped& pose);
void calcInitPose(const sensor_msgs::LaserScan & scan, geometry_msgs::PoseWithCovarianceStamped& init_pose);
void CovPoseToPose2D(const geometry_msgs::PoseWithCovarianceStamped& cov_pose, geometry_msgs::Pose2D                         & pose);

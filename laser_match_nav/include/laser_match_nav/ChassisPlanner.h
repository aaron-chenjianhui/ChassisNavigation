...
ChassisPlanner();
ChassisPlanner(double separation, double radius, double max_speed, double accel_dist, double accel_time, double ctrl_period);
~ChassisPlanner();
...
// PID Algorithm
double AngVelPID(double err, double err_integral, double last_err, double kp, double ki, double kd);
